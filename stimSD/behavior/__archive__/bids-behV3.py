...
BIDS_ROOT = Path("/Volumes/levy/raw/valerocabre/stimSD/Data/derivatives/bidsV3/")
...
for xlsx in xlsx_files:
    ...
    if ecrf_name:
        ...
        print(f"  ⚠️  Pas de correspondance eCRF pour '{xlsx.stem}', utilisation du stem original")
