...
BIDS_ROOT = Path(
    "/Volumes/levy/raw/valerocabre/stimSD/Data/derivatives/bids-V7-eCRF"
)
RANDO_XLSX = Path(
...
log.info(f"🔍 {len(patients_pairs)} patients + {len(temoins_pairs)} témoins = {len(xlsx_ecrf_list)} total\n")
